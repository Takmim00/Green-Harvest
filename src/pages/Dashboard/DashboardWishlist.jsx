          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium text-[#00B250] bg-green-50 mb-3">
                  In Stock
                </span>
                <button
                  onClick={() => handleAddToCart(item)}
                  className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-[#00B250] text-white text-sm font-semibold rounded-full hover:bg-[#009a42] transition-colors"
                >
                  <ShoppingCart size={16} />
                  Add to Cart
                </button>
