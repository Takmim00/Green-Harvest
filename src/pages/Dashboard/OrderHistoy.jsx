...
const OrderHistory = () => {
  ...
  const allOrders = [
    ...
    { id: '#5765', date: '27 Mar, 2021', total: '$25.00', products: 1, status: 'on the way' },
    ...
    { id: '#4848', date: '24 Feb, 2021', total: '$23.00', products: 1, status: 'Completed' },
    { id: '#5765', date: '20 Feb, 2021', total: '$23.00', products: 1, status: 'Completed' },
    { id: '#1577', date: '12 Oct, 2020', total: '$23.00', products: 1, status: 'Completed' },
    { id: '#2341', date: '5 Oct, 2020', total: '$145.00', products: 3, status: 'Completed' },
    { id: '#8823', date: '28 Sep, 2020', total: '$89.00', products: 2, status: 'Completed' },
    { id: '#9912', date: '15 Sep, 2020', total: '$210.00', products: 5, status: 'Completed' },
    { id: '#7734', date: '10 Sep, 2020', total: '$67.00', products: 1, status: 'Completed' },
    { id: '#6655', date: '5 Sep, 2020', total: '$320.00', products: 8, status: 'Completed' },
    { id: '#4432', date: '1 Sep, 2020', total: '$45.00', products: 1, status: 'Completed' },
  ];
